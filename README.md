...
## Getting Started
To use the app, you can simply clone the repository to your local machine and run npm install to install all the necessary dependencies. Then, run npm run dev to start the development server and open the app in your browser.Then, enter the name of the city for which you want to retrieve the weather forecast and press "Enter" or click the search button.
